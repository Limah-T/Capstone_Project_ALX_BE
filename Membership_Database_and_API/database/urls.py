...
urlpatterns = [
    ...
    path('corporatememberform', views.CorporateView.as_view(), name='corporate_view'),

    # list display views
    path('individual_database_view', views.IndividualDataBaseView.as_view(), name='ind_view'),
    path('corporate_database_view', views.CorporateDatabaseView.as_view(), name='cop_view'),
